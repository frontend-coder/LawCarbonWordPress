...
<?php get_header(); ?>
	<aside id="fh5co-hero" class="js-fullheight">
      ...
      <?php
       $header_slider = carbon_get_post_meta(get_the_ID(), 'header_slider');
      // var_dump ($header_slider);
        ?>
   <?php
        if ( $header_slider ):
         foreach ( $header_slider as $hehs ): ?>

		   	<li style="background-image: url(<?php echo $hehs['header_slider_image']; ?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1><?php echo $hehs['header_slider_title']; ?></h1>
									<h2><?php echo $hehs['header_slider_descr']; ?></h2>
									<p><a class="btn btn-primary btn-lg" href="<?php $permalink_url = $hehs['header_select_page'];
										 echo get_category_link($permalink_url); ?>">
									<?php echo $hehs['header_slider_ankor']; ?></a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
